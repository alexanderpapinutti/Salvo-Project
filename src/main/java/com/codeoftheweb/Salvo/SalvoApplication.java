...
//			gamePlayerRepository.save(gamePlayer12);
			...
			List<String> location6 = Arrays.asList("F1","G1","H1","I1","J1");
			List<String> location7 = Arrays.asList("G2","H2","I2","J2");
			List<String> location8 = Arrays.asList("H3","I3","J3");
			List<String> location9 = Arrays.asList("H4","I4","J4");
			List<String> location10 = Arrays.asList("J5","I5");
...
//
			...
			Ship ship6 = new Ship(gamePlayer2,"Destroyer", location8);
			Ship ship7 = new Ship(gamePlayer2,"Submarine", location9);
			Ship ship8 = new Ship(gamePlayer2,"Patrol-Boat", location10);
			Ship ship9 = new Ship(gamePlayer2,"Aircraft-Carrier", location6);
			Ship ship10 = new Ship(gamePlayer2,"Battleship", location7);
...
//
			List<String> p1r1 = Arrays.asList("H1","I1","J1","G1","F1");
			List<String> p2r1 = Arrays.asList("H1","I1","J1");
			List<String> p1r2 = Arrays.asList("A5","D5");
...
//			Score score3 = new Score(1, player1, game2);
//			Score score4 = new Score(0, player2, game2);
//			Score score5 = new Score(0.5, player2, game3);
//			Score score6 = new Score(0.5, player3, game3);
//			Score score7 = new Score(0, player1, game4);
//			Score score8 = new Score(1, player2, game4);
//			Score score9 = new Score(1, player4, game6);
//			Score score10 = new Score(0, player3, game6);
//
